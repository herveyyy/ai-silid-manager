...
export const classWorkCategoryRelations = relations(
    classWorkCategory,
    ({ one, many }) => ({
        classCard: one(classCard, {
...
export const activityWithTagsRelations = relations(
    activityWithTags,
    ({ one }) => ({
...
export const chatboxMessagesRelations = relations(
    chatboxMessages,
    ({ one, many }) => ({
        chatbox: one(chatbox, {
...
export const sectionQuestionsRelations = relations(
    sectionQuestions,
    ({ one, many }) => ({
        questions: many(questions),
        activity: one(activities, {
...
export const studentActivityRelations = relations(
    studentActivity,
    ({ one, many }) => ({
...
export const notificationDeviceRelations = relations(
    notificationDevice,
    ({ one }) => ({
        user: one(users, {
