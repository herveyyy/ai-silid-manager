    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-2xl font-mono text-[12px] leading-relaxed text-[var(--muted)]">
          ...
          <span className="text-[var(--muted-strong)]">Total storage</span> and{" "}
          <span className="text-[var(--muted-strong)]">Total tokens</span>.
        </p>
      </div>
      ...
      <p className="font-mono text-[11px] text-[var(--muted)]">
        <Link
          href="/dashboard"
          className="theme-link text-[var(--muted-strong)] underline underline-offset-2"
        >
          Back to dashboard
        </Link>
      </p>
